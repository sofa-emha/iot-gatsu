...
<head>
  <!-- Title -->
  <title>Data dan Statistik | Penyiram Tanaman</title>
        ...
        <div class="row align-items-center">
          <div class="col">
            <div class="d-none d-lg-block">
              <h1 class="h2 text-white">Penyiram Tanaman</h1>
            </div>
            ...
            <ol class="breadcrumb breadcrumb-light breadcrumb-no-gutter mb-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Penyiram Tanaman</li>
            </ol>
            <!-- End Breadcrumb -->
          </div>
              ...
              <div class="card mb-5">
                <div class="card-body">
                  ...
                  <ul class="nav nav-sub nav-sm nav-tabs nav-list-y-2 mb-4">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="watering.php">
              ...
              <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle text-center">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>16.00</td>
                    <td>28/11/2020</td>
                    <td><span class="badge badge-soft-primary">On-Going</span></td>
                  </tr>
                  <tr>
                    <td>#785</td>
                    <td>08.00</td>
                    <td>29/11/2020</td>
                    <td><span class="badge badge-soft-secondary">Waiting</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
