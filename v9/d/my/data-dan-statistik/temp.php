...
<head>
  <!-- Title -->
  <title>Data dan Statistik | Suhu dan Temperatur</title>
        ...
        <div class="row align-items-center">
          <div class="col">
            <div class="d-none d-lg-block">
              <h1 class="h2 text-white">Suhu dan Temperatur</h1>
            </div>
            ...
            <ol class="breadcrumb breadcrumb-light breadcrumb-no-gutter mb-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Suhu dan Temperatur</li>
            </ol>
            <!-- End Breadcrumb -->
          </div>
          ...
          <div class="d-sm-flex justify-content-center align-items-center">
            ...
            <a class="js-toggle-state btn btn-sm btn-primary btn-block" href="javascript:;"
               data-hs-toggle-state-options='{
                 "targetSelector": "#kipas-toggle",
                 "slaveSelector": "#toggleKipasAll"
               }'>
