...
<head>
  <!-- Title -->
  <title>Data dan Statistik | Gerbang dan Pintu Rumah</title>
        ...
        <div class="row align-items-center">
          <div class="col">
            <div class="d-none d-lg-block">
              <h1 class="h2 text-white">Gerbang dan Pintu Rumah</h1>
            </div>
              ...
              <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle text-center">
                ...
                <tbody>
                  <tr>
                    <td>#781</td>
                    <td>1</td>
                    <td><span class="badge badge-soft-secondary">Off</span></td>
                  </tr>
                  <tr>
                    <td>#782</td>
                    <td>2</td>
