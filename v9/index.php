      ...
      <div class="container">
        <div class="row no-gutters">
          <div class="col-md-8 col-lg-7 col-xl-6 offset-md-2 offset-lg-2 offset-xl-3">
            <!-- Form -->
            <form class="js-validate" action="./d/my/data-dan-statistik/" autocomplete="off" method="POST">
              <!-- Title -->
              ...
              <div class="js-form-message form-group">
                ...
                <input type="text" class="form-control" name="usr" id="loginUser" tabindex="1" placeholder="Nama Pengguna" aria-label="username" required
                       data-msg="Tulis nama pengguna dengan benar.">
              </div>
              <!-- End Form Group -->
              ...
              <div class="js-form-message form-group">
                ...
                <input type="password" class="form-control" name="pwd" id="loginPassword" tabindex="2" placeholder="********" aria-label="********" required
                       data-msg="Tulis kata sandi dengan benar.">
              </div>
              <!-- End Form Group -->
              ...
              <div class="row align-items-center mb-5">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  ...
                  <a class="font-size-1 font-weight-bold" href="#">Daftar disini</a>
                </div>

                <div class="col-sm-6 text-sm-right">
                  <button type="submit" class="btn btn-sm btn-primary transition-3d-hover">Masuk Akun</button>
                </div>
              </div>
              <!-- End Button -->
            </form>
