            ...
            <div id="sidebarNav" class="collapse navbar-collapse navbar-vertical">
              ...
              <div class="card mb-5">
                <div class="card-body">
                  ...
                  <?php require('auto/content/navMenu.php'); ?>
        ...
        <div class="col-lg-9">
          ...
          <div class="card mb-3 mb-lg-5">
            <div class="card-header justify-content-center">
              <h3 class="card-header-title">Rumah Pintar</h3>
            </div>
              ...
              <form>
                <div class="list-group list-group-lg list-group-flush list-group-no-gutters">
                  ...
                  <div class="list-group-item">
                    <div class="media">
                      <i class='bx bx-home list-group-icon mt-1 bx-sm'></i>
                      <div class="media-body">
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-auto">
                            <a class="btn btn-xs btn-white" href="./rumah-pintar/">Buka Halaman</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-auto">
                            <a class="btn btn-xs btn-white" href="./rumah-pintar/gate.php">Buka Halaman</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-auto">
                            <a class="btn btn-xs btn-white" href="./rumah-pintar/lamp.php">Buka Halaman</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-auto">
                            <a class="btn btn-xs btn-white" href="./rumah-pintar/watering.php">Buka Halaman</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-auto">
                            <a class="btn btn-xs btn-white" href="./data-dan-statistik/">Buka Halaman</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-auto">
                            <a class="btn btn-xs btn-white" href="./data-dan-statistik/gate.php">Buka Halaman</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-auto">
                            <a class="btn btn-xs btn-white" href="./data-dan-statistik/lamp.php">Buka Halaman</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-auto">
                            <a class="btn btn-xs btn-white" href="./data-dan-statistik/temp.php">Buka Halaman</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-auto">
                            <a class="btn btn-xs btn-white" href="./data-dan-statistik/watering.php">Buka Halaman</a>
                          </div>
                        </div>
                      </div>
                    </div>
