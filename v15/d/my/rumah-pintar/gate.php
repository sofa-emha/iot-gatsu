...
<head>
  <!-- Title -->
  <title>Rumah Pintar | Gerbang Rumah</title>
        ...
        <div class="row align-items-center">
          <div class="col">
            <div class="d-none d-lg-block">
              <h1 class="h2 text-white">Pengaturan Gerbang Rumah</h1>
            </div>
                    ...
                    <div class="col-12 px-2">
                      ...
                      <div class="card border shadow-none text-center">
                        ...
                        <div class="card-body p-4">
                          ...
                          <a href="_gateOff.php" class="btn btn-block btn-primary">OFF</a>
                          <a href="_gateOn.php" class="btn btn-block btn-primary">ON</a>
